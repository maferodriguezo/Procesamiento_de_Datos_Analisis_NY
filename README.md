# **ProyectoNY - Análisis Exploratorio de Datos Territoriales en Nueva York**

[![Python](https://img.shields.io/badge/Python-3.9%2B-blue)](https://www.python.org/)
[![PySpark](https://img.shields.io/badge/PySpark-3.5%2B-orange)](https://spark.apache.org/)
[![Jupyter](https://img.shields.io/badge/Jupyter-Notebook-orange)](https://jupyter.org/)
[![Spark](https://img.shields.io/badge/Apache_Spark-Distributed_Processing-red)](https://spark.apache.org/)

**Análisis exploratorio integral de datos territoriales del estado de Nueva York aplicando procesamiento distribuido con PySpark.**

## **Autores**
- **Estudiante:** María Fernanda Rodríguez Ospina
- **Profesor:** John Corredor Franco, PhD
...
| **PySpark** | 3.5.2 | Procesamiento distribuido de datos |
| **Apache Spark** | 3.5.2 | Motor de procesamiento distribuido |
| **Jupyter Notebook** | - | Entorno de desarrollo interactivo |
| **Clúster HPC** | - | Infraestructura de procesamiento |
